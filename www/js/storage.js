...
(function () {
  const DB_VERSION = 5;
  const STORES = ['accounts', 'categories', 'transactions', 'reminders', 'meta', 'books', 'loans', 'budgets', 'goals'];
  ...
  const Store = {
    ...
    async deleteBook(bookId) {
      for (const s of ['accounts', 'categories', 'transactions', 'reminders', 'loans', 'budgets', 'goals']) {
